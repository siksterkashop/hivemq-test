...
public class Substitution {
     ...
     */
    @NotNull
    public static String substitute(final @NotNull String topic, final @NotNull String clientId, final @NotNull String username) {

        final StringSubstitutor strSubstitutor = new StringSubstitutor(new StringLookup() {
            @Nullable
            @Override
            public String lookup(final @NotNull String key) {
