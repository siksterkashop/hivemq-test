...
public class XmlParser {
     ...
     */
    public void marshal(final @NotNull FileAuthConfig config, final @NotNull File file) throws NotMarshallableException {
    ...
    @NotNull
    public FileAuthConfig unmarshalFileAuthConfig(final @NotNull File file) throws IOException {
    ...
    @NotNull
    public ExtensionConfig unmarshalExtensionConfig(final @NotNull File file) throws IOException {
